...
I need to make sure that if the same video is uploaded, we only save the stems once for all users. 

add a upload section so users can upload files

add a record file so users audio from their device can be recorded

download buttons to download stems, cut stems, whole tracks etc.
...
I want to be able to change the loudness of a stem
...
COMPLETED:
if i click on a stem and press backspace it should get deleted from the track (not the libary)

I want to be able to delete a stem from the library
